...
use ReindeerWeb\AutoGitIgnore\Exceptions\AutoGitIgnoreParserException;
use ReindeerWeb\AutoGitIgnore\Exceptions\AutoGitIgnorePermissionException;
use ReindeerWeb\AutoGitIgnore\Exceptions\AutoGitIgnoreSaveException;
